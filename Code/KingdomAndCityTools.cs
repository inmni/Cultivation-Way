...
{
    internal static class KingdomAndCityTools
    {
        ...
        public static int produceMore(Actor pActor, BuildingType buildingType)
        {
            ...
            {
                return (int)(ExtendedKingdomStats.getStatus(pActor.kingdom.id, "MountainGod") + 0.5f);//1
            }
            else if (buildingType == BuildingType.Wheat)
            {
                return (int)(ExtendedKingdomStats.getStatus(pActor.kingdom.id, "EarthGod") + 0.5f);//1
            }
            return 0;
        }
        public static int gainMoreFromTrade(Actor pActor)
        {
            ...
            return (int)(ExtendedKingdomStats.getStatus(pActor.kingdom.id, "Mammon") * 3 + 0.5) + 5;//8
        }
